...
if True:
    ...
    wordsDict = {
    0: {'word': 'pencil', 'tranlations': json.dumps(['карандаш', 'кисть'], ensure_ascii=False), 'status': 0},
    ...
    i = 0
    for i in wordsDict:
        insertRowQuery = f"INSERT INTO words (id, word, translations, status) VALUES(0, '{wordsDict[i]['word']}', '{wordsDict[i]['tranlations']}', '{wordsDict[i]['status']}')"
